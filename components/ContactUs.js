  ...
  return (
    ...
    <div className="grid grid-cols-5 mb-10">
        <div className="bg-pink-600 " >
            <img className="hidden md:block" src= "https://images.unsplash.com/photo-1670272505284-8faba1c31f7d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxzZWFyY2h8OHx8b2ZmaWNlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60" altext="background image"></img>
        </div>
